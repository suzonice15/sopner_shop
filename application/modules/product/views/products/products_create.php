                                ...
                                <div class="box box-primary" style="border: 2px solid #ddd;height: 550px">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group featured-image">
                                            ...
                                            <br>
                                            <input type="text" placeholder="Enter image Permalink" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <br>
                                                <input placeholder="Enter image Permalink" type="text"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <br>
                                            <input placeholder="Enter image Permalink" type="text" class="form-control"
