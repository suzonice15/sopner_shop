...
<div class="form-group ">
	<label for="page_template">Page Location </label>
	<select name="page_position" class="form-control" >
		<option value="home" >Top Menu</option>
...
<div class="form-group ">
	<label for="page_template">Page Rank Order  </label>

	<input required type="text" id="category_title" class="form-control the_title" name="page_order" value="<?php if(isset($page)){ echo $page->page_order;} ?>">
